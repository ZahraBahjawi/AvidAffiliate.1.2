              ...
              <div className="space-y-12 md:space-y-0 md:grid md:grid-cols-3 md:gap-8">
                ...
                <div className="text-center group">
                  <div className="relative mb-6">
                    ...
                    <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-violet-600 text-white rounded-2xl flex items-center justify-center mx-auto shadow-lg transform group-hover:scale-105 transition-all duration-300">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mt-16">
              ...
              <div>
                <button
                  onClick={() => {
                    track('cta_click', { location: 'about_section' });
                    const heroForm = document.querySelector('#hero-form');
                    if (heroForm) {
                      heroForm.scrollIntoView({ behavior: 'smooth', block: 'center' });
                    }
          ...
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
              <button
                ...
                className="inline-flex items-center px-8 py-4 bg-transparent border-2 border-white text-yellow text-base font-bold rounded-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300 shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-yellow"
              >
                Get my free Report Card
                <ArrowRight className="ml-2 h-4 w-4" />
              </button>
...
" and want to make the following changes.
The following represents a line-by-line diff of the changes that I want to make to the file.
...
-                                            <div className="text-sm text-red-600">[amazon.com/product-xyz](https://amazon.com/product-xyz) → 404 error</div>
-                                        </div>
-                                    </div>
-                                </div>
...
+        icon: XCircle,
+        title: "Broken affiliate link found",
+        description: "[amazon.com/product-xyz](https://amazon.com/product-xyz) → 404 error",
+        color: "red",
+      },
+      fix: {
+        icon: CheckCircle,
